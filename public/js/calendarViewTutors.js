  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      events: @JSON($listTutorEvents),

      // eventSources:{
      //   url: eventsURL+'/events.tutorsViews',
      //   method:'POST',
      //   extraParams:{
        ...
        then(
          (respo) => {
            ...
            if(respo.data[14] === 'notRecurrent' ){
              ...
              formCreateEvent.startTime.value = respo.data[7];  
              formCreateEvent.endTime.value = respo.data[8];
              formCreateEvent.employee.value = respo.data[9];
              formCreateEvent.tutor.value = respo.data[10];
              formCreateEvent.student.value = respo.data[11];
              formCreateEvent.room.value = respo.data[12];
              formCreateEvent.id.value = respo.data[13];
