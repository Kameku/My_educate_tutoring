    ...
    <div class="col-12">
        @can('administrator.roles.create')
            <div class="d-flex flex-row-reverse bd-highlight align-items-center">
                <a href="{{ route('administrator.roles.create') }}" class="btn btn-primary d-inline mx-2 mt-1">Create
                    Role</a>
            </div>
            ...
            <div class="card rounded">
                ...
                <div class="input-group input-group-lg">
                    ...
                    <input wire:model="search" type="text" class="form-control" aria-label="Sizing example input"
                        aria-describedby="inputGroup-sizing-lg" placeholder="Search role">
                </div>
                                            ...
                                            <tr>
                                                ...
                                                @can('administrator.roles.edit')
                                                    ...
                                                    <td style="width: 50px">
                                                        ...
                                                        <div class="d-flex-inline">
                                                            @if ($role->name == 'superadmin' or $role->name == 'dissabled')
                                                            <button class="btn btn-sm btn-primary" disabled style="cursor: not-allowed;">Edit</button>
                                                            @else
                                                                
                                                            <a href="{{ route('administrator.roles.edit', $role) }}"
                                                                class="btn btn-primary btn-sm btn-block text-white">Edit</a>
                                                            @endif
                                                ...
                                                @can('administrator.roles.destroy')
                                                    ...
                                                    <td style="width: 50px">
                                                        ...
                                                        <div class="d-flex-inline">
                                                            @if ($role->name == 'superadmin' or $role->name == 'admin' or $role->name == 'tutor' or $role->name == 'student' or $role->name == 'parent' or $role->name == 'dissabled')
                                                            <button class="btn btn-sm btn-danger" disabled style="cursor: not-allowed;">Delete</button>
                                                                
                                                            @else
                                                                
                                                                {{-- <button href="{{route('dashboard.index')}}" class="btn btn-sm btn-danger" >Delete</button> --}}
