...
<body>
                ...
                <div class="card-body">
                        <div class="row">
                            <div class="col-3"> 
                                ...
                                <small id="helpId" class="text-muted">subject seleccionado</small>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                <label for="">Tutor</label>
                                <input type="text" name="tutor" id="tutor" class="form-control " placeholder="" readonly aria-describedby="helpId" value="{{ $tutor->first_name.' '.$tutor->last_name }}">
                                <small id="helpId" class="text-muted">subject seleccionado</small>
                                </div>
                            </div>
                            <div class="col-5">
                                ...
                                <input type="text" name="student" id="student" class="form-control " placeholder="" readonly aria-describedby="helpId" value="{{ $student->first_name.' '.$student->last_name }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    @include('events.createEventEnrolment')
    @endsection
...
function sendDataForm(url){
    ...
    then(
      (respo) => {
        ...
        // if(Auth::guest()){
        //     location.replace('http://edu.test/index');
        // }else{
            location.replace('http://edu.test/thanks');
        // }
