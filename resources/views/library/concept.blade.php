...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-auto">
            <a href="{{ route('library.show', ['library' => $subject->id]) }}" class="badge badge-secondary mb-2 p-2">Go Back</a>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-auto">
            <button class="btn btn-primary px-8" data-toggle="modal" data-target="#createConceptDetails">Create Concept Details</button>
        </div>
    </div>

    <div class="row mb-3">
        <div class="col-12">
            <p class="alert alert-primary">{{$subject->name_sub.' / '.$concept->concept_name}}</p>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            aria-describedby="datatable-buttons_info">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="text-dark" style="text-transform:uppercase;">{{$detail->concept_detail_name}}</span>
                                        </td>
                                        <td style="width: 50px">
                                            <a href="{{route('detail.show', ['detail' => $detail->id])}}" class="btn btn-sm btn-info btn-block">View</a>
                                        </td>
                                        <td style="width: 50px">
                                            <a class="btn btn-primary btn-sm text-white btn-block" data-toggle="modal" data-target="#conceptDetailEdit{{$detail->id}}">Edit</a> 
                                            @include('library.conceptDetailEditModal') 
                                        </td>
                                        <td style="width: 50px">
                                            
                                            @if (count($detail->Learnings) > 0)
...
@if($errors->any())
    <script>
        $('#createConceptDetails').modal('show');
    </script>
@endif
